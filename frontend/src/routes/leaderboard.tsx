    ...
    <div>
          ...
          <div className="flex justify-between m-1">
            <div>
              <input
                ...
                className="rounded-3xl text-sm h-12 w-80 bg-[#25293E] pl-8"
              />
            </div>
            <div className="flex justify-between w-110 z-20">
              <div className="flex flex-col">
                <div
                  className="rounded-3xl text-sm h-10 w-50 bg-[#25293E] flex justify-center items-center cursor-pointer mt-1 hover:bg-[#25294F]"
                ...
                {batch && (
                  <div className="mt-2 text-xs flex flex-col justify-evenly items-center">
                    <div className="bg-[#25293E] h-8 w-42 flex justify-center items-center hover:bg-[#25294F]">
                      2023
                    </div>
                    <div className="bg-[#25293E] h-8 w-42 flex justify-center items-center hover:bg-[#25294F]">
                      2022
      ...
      <div className="h-80 ml-10 mr-10 flex justify-center items-end mb-15 mt-15">
        <div className="flex justify-around items-end h-50 w-150 bg-[#1B1E30] rounded-xl">
          <div className="relative w-1/3 h-50 flex flex-col justify-evenly z-10 pt-8">
            <div className="absolute -top-13 left-16 flex justify-center items-center">
              <img
            ...
            <div className="absolute top-1 left-21.5 text-lg flex justify-center items-center bg-[#5FCABB] rounded-full w-7">
              2
            </div>
          ...
          <div className="relative w-1/3 h-65 bg-[#25293E] flex flex-col rounded-t-3xl justify-evenly z-10 pt-10">
            <div className="absolute -top-17 left-13 flex justify-center items-center">
              <img
            ...
            <div className="absolute top-3 left-21.5 text-lg flex justify-center items-center bg-[#DCBE66] rounded-full w-7">
              1
            </div>
            <div className="text-base flex justify-center items-center">
              {leaderboard[0].name}
          ...
          <div className="relative w-1/3 h-50 flex flex-col justify-evenly z-10 pt-8">
            ...
            <div className="absolute top-1 left-21.5 text-lg flex justify-center items-center bg-[#DD7A6C] rounded-full w-7">
              3
            </div>
            <div className="text-base flex justify-center items-center">
              {leaderboard[2].name}
      ...
      <div className="ml-10 mr-10 flex flex-col">
        {leaderboard.slice(3).map((user, index) => (
          <div
            key={user.id}
            className="h-15 rounded-xl flex justify-around bg-[#25293E] m-1"
          >
            ...
            <div className="w-4/20 text-base flex justify-center items-center">
              {user.name}
            </div>
            <div className="w-1/20 text-sm flex justify-center items-center">
              {user.batch || "N/A"}
